const scenes = {
  room1: {
    bg: "images/scene/Background.jpg",
    elements: [
      {
        id: "bed",
        x: 0.7, y: 0.65, w: 0.35, h: 0.5,
        desc: "铁架床",
        bg: "images/scene/Bed.png",
        action: "sleepConfirm",
        visible: true
      },
      {
    ...
    elements: [
      {
        ...
        desc: "有抽屉的桌子",
        bg: "images/scene/Desk_Close.png",
        zoom: "deskZoom",
        visible: true
      },
      {
        ...
        desc: "工具箱",
        bg: "images/scene/Toolbox_Close.png",
        zoom: "toolboxZoom",
        visible: true
      },
      {
        ...
        desc: "窗户",
        bg: "images/scene/Window_Open.png",
      ...
      },
      {
        ...
        x: 0.5, y: 0.25, w: 0.3, h: 0.45,
        desc: "窗户",
        bg: "images/scene/Window_Close.png",
    ...
    elements: [
      {
        ...
        desc: "活板门",
        bg: "images/scene/TrapDoor_Close.png",
        zoom: "trapdoorZoom",
        visible: true
      },
      {
        id: "trapdoorBg",
        x: 0.3, y: 0.72, w: 0.33, h: 0.49,
        bg: "images/scene/TrapDoor_Open.png",
        noInteract: true,
        visible: false
      },
      {
  ...
  room4: {
    ...
    elements: [
      ...
      },
      {
        ...
        desc: "一把钥匙",
        bg: "images/prop/Key_Padlock.png",
  ...
  backpackZoom: {
    elements: [
      ...
      },
      {
        ...
        bg: "images/prop/WaterBottle.png",
        desc: "水瓶",
      ...
      },
      {
        ...
        x: 0.5, y: 0.5, w: 0.5, h: 0.7,
        noInteract: true,
        bg: "images/scene/Backpack_Front.png",
        visible: true
      }
    ]
  },
  toolboxZoom: {
    elements: [
      ...
      },
      {
        id: "toolboxOpen",
        x: 0.5, y: 0.5, w: 0.5, h: 0.75,
        bg: "images/scene/Toolbox_Open.png",
        noInteract: true,
        visible: false
      },
      {
      ...
      },
      {
        id: "toolboxFront",
        x: 0.5, y: 0.5, w: 0.5, h: 0.75,
        bg: "images/scene/Toolbox_Front.png",
        noInteract: true,
        visible: false
      }
    ]
    ...
    elements: [
      {
        ...
        bg: "images/scene/Desk_Close.png",
        desc: "有抽屉的桌子",
        action: "addElement(deskZoom, deskOpen, true);addElement(deskZoom, keyDoor, true); removeElement(deskZoom, deskClose, true); setBg(room2, desk, images/scene/Desk_Open.png)",
        visible: true
      },
      {
        id: "deskOpen",
        x: 0.5, y: 0.5, w: 0.5, h: 0.75,
        bg: "images/scene/Desk_Open.png",
        noInteract: true,
        visible: false
      },
      {
  ...
  trapdoorZoom: {
    elements: [
      ...
      },
      {
        id: "trapdoorBlack",
        x: 0.5, y: 0.5, w: 0.5, h: 0.75,
        bg: "images/scene/TrapDoor_Black.png",
        desc: "黑漆漆的，得找个东西照明一下",
        noInteract: false,
        visible: false
      },
